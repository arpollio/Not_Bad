...
#
cd /scratch/arpollio/species_tree/All_v_All/
...
blastp -query sodalis_genomes.fasta -db sodalis -num_threads 12 -max_target_seqs 100 -evalue 0.0000001 -out Sodalis_Blast_results -outfmt 6
