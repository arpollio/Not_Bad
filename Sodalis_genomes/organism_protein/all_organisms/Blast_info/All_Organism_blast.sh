...
#
cd /scratch/arpollio/Not_Bad/Sodalis_genomes/organism_protein/all_organisms/Blast_info
...
blastp -query all_organisms.faa -db symbionts -num_threads 12 -max_target_seqs 100 -evalue 0.0000001 -out All_organism_Blast_results -outfmt 6
