...
#
cd /scratch/arpollio/Not_Bad/Sodalis_genomes/organism_protein/all_organisms_plus_PSPU/BLAST_info/
...
blastp -query org_plus_PSPU.faa -db symbionts_PSPU -num_threads 12 -max_target_seqs 100 -evalue 0.0000001 -out All_organism_PSPU_Blast_results -outfmt 6
