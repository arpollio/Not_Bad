...
#
cd /scratch/arpollio/Not_Bad/Sodalis_genomes/organism_protein/Enterobactericiae/Blast_info/
...
blastp -query Sodalis_clade.faa -db enterobactericiae -num_threads 12 -max_target_seqs 100 -evalue 0.0000001 -out Sodalis_Blast_results -outfmt 6
